...
alias rdesktop1280='r\desktop -0 -z -g1280x1024 -uAdministrador -kes -a16'
...
alias chrotor='chromium --no-first-run --user-data-dir=/tmp/$(date +%F_%H:%M:%S:%N) --proxy-server="localhost:8118"'
